...
namespace AtnaApi.Model
{
	...
	public class CodeValue<T>
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CodeValue{T}"/> class.
		/// </summary>
		public CodeValue()
		{
		}
		...
		public CodeValue(T code, string codeSystem) : this(code)
		{
		...
		public CodeValue(T code, string codeSystem, string displayName) : this(code, codeSystem)
		{
